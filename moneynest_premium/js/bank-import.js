...
;(function () {
  ...
  const AUTO_CATEGORY_RULES = [
    { category: 'Alimentación', patterns: [
        ...
        'CONGELADOS','FROIDEVAUX','LA SIRENA','GM FOOD','UDACO','ECOMERCADO','VERITAS','ORIGEN','HERBOLARIO','HERBORISTERIA',
        'CASH FRESH','MAKRO','COSTCO','SUMA SUPERMERCADOS','UVESCO','BM SUPERMERCADOS','EL ARBOL',
      ] },
    { category: 'Restaurantes', patterns: [
        ...
        'TACO BELL','FIVE GUYS','POPEYES','PANS COMPANY','PANS & COMPANY','ROSTISSERIA','ASADOR','MARISQUERIA','SUSHI','WOK','KEBAB','DONER',
        'CHOCOLATERIA','HELADERIA','GELATERIA','GRANJA ','XOCOLATERIA','VIPS','FOSTERS HOLLYWOOD','TGB','LIZARRAN','CERVECERIA CRUZCAMPO','GINOS',
        'ROCK AND BLUES','LA TAGLIATELLA','FRIDAYS','GOCCO CAFE','CAFETO','NOSTRUM','DELIVEROO','RAPPI',
      ] },
    ...
    { category: 'Transporte', patterns: [
        ...
        'ITV ','INSPECCION TECNICA','TALLER MECANICO','TALLER ','NEUMATICOS','FEU VERT','NORAUTO','MIDAS','KWIK FIT','CARGLASS','GRUA','ASISTENCIA EN CARRETERA',
        'AVIS','HERTZ','EUROPCAR','SIXT','ALQUILER COCHE','LANZADERA AEROPUERTO','EASYJET','AIR EUROPA','AIRFRANCE','LUFTHANSA','WIZZ AIR','ALSA','EMT ','TUSSAM',
        'BICIMAD','ORANGE BIKE','LIME ','VOI ','DOTT ','CABIFY MOTO','FLIXBUS','WORLDLINE PARKING','APCOA','SABA APARCAMIENTOS',
      ] },
    { category: 'Suscripciones', patterns: [
        ...
        'VODAFONE','MOVISTAR','ORANGE ESP','YOIGO','JAZZTEL','MASMOVIL','MAS MOVIL','PEPEPHONE','DIGI MOBIL','LOWI','O2 ','SIMYO','FINETWORK','LEBARA','ONO',
        'CRUNCHYROLL','TWITCH','DAZN','MOVISTAR PLUS','ATRESPLAYER','FILMIN','MUBI','AUDIBLE','KINDLE UNLIMITED','LINKEDIN PREMIUM','CANVA','ADOBE',
        'MICROSOFT 365','OFFICE 365','DROPBOX','GOOGLE ONE','GOOGLE STORAGE','NORDVPN','EXPRESSVPN','NOTION','CHATGPT','OPENAI','CLAUDE.AI',
      ] },
    { category: 'Tecnología', patterns: [
        'APPLE STORE','MEDIAMARKT','PCCOMPONENTES','FNAC','WORTEN','MICROSOFT STORE','XIAOMI STORE','SAMSUNG STORE','GAME ','GAMESTOP','EL CORTE INGLES ELECTRO',
        'MSY ','CEX ','PHONE HOUSE','YOIGO STORE','ELECTRO CASH','AMAZON.ES','AMAZON.COM',
      ] },
    { category: 'Ocio', patterns: [
        'CINE ','CINES ','YELMO','CINESA','KINEPOLIS','ODEON','TEATRO ','MUSEO ','ENTRADAS.COM','TICKETMASTER','FEVER ','ATRAPALO ENTRADAS',
        'BOOKING.COM','AIRBNB','EXPEDIA','TRIVAGO','HOTELES.COM','HOSTELWORLD','TRIPADVISOR','LASTMINUTE','LOGITRAVEL','EDREAMS','VUELING PACK',
        'PARQUE DE ATRACCIONES','PORT AVENTURA','WARNER PARK','ZOO ','AQUARIUM','ACUARIO','BOLERA','BOWLING','ESCAPE ROOM','KARTING','PADEL INDOOR',
        'GOOGLE PLAY','PLAYSTATION STORE','STEAM ','STEAMGAMES','NINTENDO ESHOP','EPIC GAMES','RIOT GAMES','BLIZZARD',
        'BASIC FIT','BASICFIT','GO FIT','METROPOLITAN','VIVAGYM','DIR GYM','O2 CENTRO WELLNESS','ANYTIME FITNESS','MCFIT','ALTAFIT','FITNESS PARK',
        'PELUQUERIA','PERRUQUERIA','BARBERIA','ESTETICA ','CENTRO ESTETICA','SPA ','MASAJE','UNA MAS UNA','SALON DE BELLEZA',
      ] },
    { category: 'Salud', patterns: [
        'FARMACIA','FARMACIA ','CLINICA','HOSPITAL','DENTISTA','CLINICA DENTAL','FISIOTERAPIA','FISIOTERAPEUTA','OPTICA','OPTICA ','GENERAL OPTICA',
        'MULTIOPTICAS','OPTICALIA','VETERINARIO','VETERINARIA','CLINICA VETERINARIA','PSICOLOGO','PSICOLOGA','PSICOLOGIA','LABORATORIO ANALISIS',
        'QUIROMASAJE','PODOLOGO','PODOLOGIA','LOGOPEDA','NUTRICIONISTA','DIETISTA',
      ] },
    { category: 'Seguros', patterns: [
        'MAPFRE','MUTUA MADRILE','AXA SEGUROS','ALLIANZ','LINEA DIRECTA','DIRECT SEGUROS','ADESLAS','SANITAS','DKV','ASISA','CIGNA','CASER SEGUROS',
        'GENERALI','ZURICH SEGUROS','REALE SEGUROS','PELAYO SEGUROS','FIATC','OCASO','SEGURCAIXA','VERTI SEGUROS','FENIX DIRECTO','QUALITAS AUTO',
      ] },
    { category: 'Vivienda', patterns: [
        ...
        'IKEA','LEROY MERLIN','BRICOMART','BRICODEPOT','BAUHAUS','CONFORAMA','KENAY HOME','MAISONS DU MONDE','EL CORTE INGLES HOGAR','AKI BRICOLAJE',
        'TOTAL ENERGIES ELECTRIC','REPSOL LUZ','HOLALUZ','OCTOPUS ENERGY','PODO ENERGIA','FACTOR ENERGIA','EDP ESPAÑA','ALQUILER PISO','ALQUILER VIVIENDA',
      ] },
    { category: 'Ropa', patterns: [
        'ZARA ','H&M','MANGO','PULL AND BEAR','PULL&BEAR','BERSHKA','STRADIVARIUS','NIKE','ADIDAS','DECATHLON','PRIMARK',
        'MASSIMO DUTTI','OYSHO','C&A','KIABI','LEFTIES','TOMMY HILFIGER','LEVIS','CALZEDONIA','INTIMISSIMI','TEZENIS','FOOT LOCKER',
        'JD SPORTS','SPRINTER','EL GANSO','DESIGUAL','MULAYA','BIMBA Y LOLA','TOUS ',
      ] },
    { category: 'Educación', patterns: [
        'UNIVERSIDAD','UNIVERSITAT','ACADEMIA','COURSERA','UDEMY','LIBRERIA','LLIBRERIA','MASTER ','FORMACION','EDITORIAL',
        'DUOLINGO','BRITISH COUNCIL','ESCUELA IDIOMAS','AUTOESCUELA','CAMPUS ',
      ] },
  ];
  ...
  const KNOWN_MERCHANTS = [
    ...
    { canonical: 'CONDIS', patterns: ['CONDIS'] },
    { canonical: 'COVIRAN', patterns: ['COVIRAN'] },
    { canonical: 'GADIS', patterns: ['GADIS'] },
    { canonical: 'MAKRO', patterns: ['MAKRO'] },
    ...
    { canonical: 'FREE NOW', patterns: ['FREE NOW', 'FREENOW'] },
    { canonical: 'ITV', patterns: ['ITV '] },
    { canonical: 'AVIS', patterns: ['AVIS'] },
    { canonical: 'HERTZ', patterns: ['HERTZ'] },
    { canonical: 'EUROPCAR', patterns: ['EUROPCAR'] },
    ...
    { canonical: 'BURGER KING', patterns: ['BURGER KING'] },
    { canonical: 'KFC', patterns: ['KFC'] },
    { canonical: 'SUBWAY', patterns: ['SUBWAY'] },
    { canonical: 'TELEPIZZA', patterns: ['TELEPIZZA'] },
    { canonical: 'DOMINOS', patterns: ['DOMINOS'] },
    { canonical: 'GOIKO', patterns: ['GOIKO'] },
    { canonical: 'FIVE GUYS', patterns: ['FIVE GUYS'] },
    { canonical: 'TACO BELL', patterns: ['TACO BELL'] },
    { canonical: 'VIPS', patterns: ['VIPS'] },
    { canonical: 'DELIVEROO', patterns: ['DELIVEROO'] },
    // Tobacco
    ...
    { canonical: 'DISNEY PLUS', patterns: ['DISNEY PLUS', 'DISNEY+'] },
    { canonical: 'HBO MAX', patterns: ['HBO MAX', 'HBO', 'MAX.COM'] },
    { canonical: 'PRIME VIDEO', patterns: ['PRIME VIDEO'] },
    { canonical: 'GOOGLE PLAY', patterns: ['GOOGLE PLAY'] },
    { canonical: 'STEAM', patterns: ['STEAM'] },
    { canonical: 'PLAYSTATION', patterns: ['PLAYSTATION'] },
    { canonical: 'XBOX', patterns: ['XBOX'] },
    { canonical: 'MEDIAMARKT', patterns: ['MEDIAMARKT'] },
    { canonical: 'FNAC', patterns: ['FNAC'] },
    { canonical: 'WORTEN', patterns: ['WORTEN'] },
    { canonical: 'PCCOMPONENTES', patterns: ['PCCOMPONENTES'] },
    // Telecom
    { canonical: 'VODAFONE', patterns: ['VODAFONE'] },
    { canonical: 'MOVISTAR', patterns: ['MOVISTAR'] },
    { canonical: 'ORANGE', patterns: ['ORANGE ESP', 'ORANGE '] },
    { canonical: 'YOIGO', patterns: ['YOIGO'] },
    { canonical: 'JAZZTEL', patterns: ['JAZZTEL'] },
    { canonical: 'MASMOVIL', patterns: ['MASMOVIL', 'MAS MOVIL'] },
    { canonical: 'PEPEPHONE', patterns: ['PEPEPHONE'] },
    { canonical: 'DIGI', patterns: ['DIGI MOBIL', 'DIGI '] },
    { canonical: 'LOWI', patterns: ['LOWI'] },
    { canonical: 'SIMYO', patterns: ['SIMYO'] },
    // Home / furniture
    { canonical: 'IKEA', patterns: ['IKEA'] },
    { canonical: 'LEROY MERLIN', patterns: ['LEROY MERLIN'] },
    { canonical: 'BRICOMART', patterns: ['BRICOMART'] },
    { canonical: 'CONFORAMA', patterns: ['CONFORAMA'] },
    // Travel / accommodation
    { canonical: 'BOOKING.COM', patterns: ['BOOKING.COM', 'BOOKING COM'] },
    { canonical: 'AIRBNB', patterns: ['AIRBNB'] },
    { canonical: 'EXPEDIA', patterns: ['EXPEDIA'] },
    { canonical: 'RYANAIR', patterns: ['RYANAIR'] },
    { canonical: 'VUELING', patterns: ['VUELING'] },
    { canonical: 'IBERIA', patterns: ['IBERIA'] },
    { canonical: 'EASYJET', patterns: ['EASYJET'] },
    // Insurance
    { canonical: 'MAPFRE', patterns: ['MAPFRE'] },
    { canonical: 'AXA', patterns: ['AXA SEGUROS', 'AXA '] },
    { canonical: 'ALLIANZ', patterns: ['ALLIANZ'] },
    { canonical: 'ADESLAS', patterns: ['ADESLAS'] },
    { canonical: 'SANITAS', patterns: ['SANITAS'] },
    { canonical: 'DKV', patterns: ['DKV'] },
    { canonical: 'LINEA DIRECTA', patterns: ['LINEA DIRECTA'] },
    // Gyms
    { canonical: 'BASIC FIT', patterns: ['BASIC FIT', 'BASICFIT'] },
    { canonical: 'GO FIT', patterns: ['GO FIT'] },
    { canonical: 'METROPOLITAN', patterns: ['METROPOLITAN'] },
    { canonical: 'VIVAGYM', patterns: ['VIVAGYM'] },
    { canonical: 'MCFIT', patterns: ['MCFIT'] },
    // Clothing
    { canonical: 'ZARA', patterns: ['ZARA '] },
    { canonical: 'H&M', patterns: ['H&M'] },
    { canonical: 'MANGO', patterns: ['MANGO'] },
    { canonical: 'BERSHKA', patterns: ['BERSHKA'] },
    { canonical: 'PULL AND BEAR', patterns: ['PULL AND BEAR', 'PULL&BEAR'] },
    { canonical: 'STRADIVARIUS', patterns: ['STRADIVARIUS'] },
    { canonical: 'PRIMARK', patterns: ['PRIMARK'] },
    { canonical: 'DECATHLON', patterns: ['DECATHLON'] },
    { canonical: 'NIKE', patterns: ['NIKE'] },
    { canonical: 'ADIDAS', patterns: ['ADIDAS'] },
    { canonical: 'MASSIMO DUTTI', patterns: ['MASSIMO DUTTI'] },
    { canonical: 'C&A', patterns: ['C&A'] },
    ...
    { canonical: 'PAYPAL', patterns: ['PAYPAL'] },
  ];
  ...
  function _ensureStyles() {
    ...
    s.id = 'mn-bi-style';
    // Only this overlay's own sizing/z-index needs to be injected here
    // — every generic .mnbi-* class is now static CSS
    // (css/wizard-shared.css, always loaded) shared with every other
    // step-wizard in the app (investment, income/expense), instead of
    // being defined only here and silently missing for anyone who
    // opens a different wizard first in a session.
    s.textContent = `
